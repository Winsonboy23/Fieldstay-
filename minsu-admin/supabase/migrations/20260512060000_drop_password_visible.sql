-- Drop plaintext password column (was demo-only, never store plaintext passwords).
alter table public.guests drop column if exists password_visible;

-- Revert admin_create_guest to NOT write plaintext password.
...
-- Revert admin_set_guest_password to NOT write plaintext password.
